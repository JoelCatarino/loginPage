...
export function App() {
  return (
    <div className="flex-col w-screen h-screen bg-gray-900 text-gray-100 flex items-center justify-center">
      ...
      <footer className="flex flex-col items-center gap-4 mt-8">
        <Text asChild size="sm">
          <a href="" className="text-gray-400 underline hover:text-gray-500">
            Esqueceu a senha
          </a>
        </Text>
        <Text asChild size="sm">
